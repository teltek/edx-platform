    ...
    'certificates': [
        {
            ...
            'course_program_path': '/path/to/course_program.pdf',
            'course_credits': '1.0',
            'signatories': [
                {
...
class CertificateManager(object):
    ...
    def serialize_certificate(certificate):
        ...
        if certificate_data.get('course_credits'):
            certificate_response["course_credits"] = certificate_data['course_credits']
