...
define(['jquery', 'gettext', 'common/js/components/utils/view_utils', 'js/views/utils/create_utils_base'],
    function($, gettext, ViewUtils, CreateUtilsFactory) {
        ...
        return function(selectors, classes) {
            ...
            var keyFieldSelectors = [selectors.org, selectors.number, selectors.run, selectors.effort];
            var nonEmptyCheckFieldSelectors = [selectors.name, selectors.org, selectors.number, selectors.run, selectors.effort];
