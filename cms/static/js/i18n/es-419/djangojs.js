...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "Create an {platform} account": "Cree una cuenta para {platform}", 
    ...
    "File format not supported. Please upload a file with a {ext} extension.": "Formato de archivo no soportado. Debe cargar un archivo con extensi\u00f3n {ext}", 
    ...
    "Wrong offset!": "\u00a1Desplazamiento incorrecto!", 
