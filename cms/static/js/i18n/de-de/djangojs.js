...
(function (globals) {
  ...
  django.catalog = {
    ...
    "Add your post to a relevant topic to help others find it.": "F\u00fcgen Sie Ihren Beitrag zu einem entsprechenden Thema hinzu, um andern das Auffinden zu erleichtern.", 
    "Adding": "Hinzuf\u00fcgen", 
    ...
    "Choose Course Date": "W\u00e4hlen Sie den Kurstermin", 
    ...
    "Course Credits": "Kursnachweise", 
    "Course Credits Override": "Kurs-Credits \u00fcberschreiben", 
    "Course End": "Kursende", 
    ...
    "Discussion admins, moderators, and TAs can make their posts visible to all students or specify a single cohort.": "Forumsadministratoren, Moderatoren und Dozenten k\u00f6nnen ihre Beitr\u00e4ge f\u00fcr alle Teilnehmer sichtbar machen oder sie nur einer festgelegten Gro\u00dfgruppe zug\u00e4nglich machen.", 
    ...
    "Edit the program\\'s marketing slug.": "Bearbeiten Sie das marketing slug des Programms.", 
    ...
    "Error": "Fehler", 
    "Error adding students.": "Fehler beim Hinzuf\u00fcgen von Teilnehmern. ", 
    ...
    "File": "Datei", 
    "File Name": "Dateiname", 
    "File format not supported. Please upload a file with a {file_extension} extension.": "Dateiformat nicht unterst\u00fctzt. Bitte laden Sie eine Datei mit der Endung {file_extension} hoch.", 
    "File must be in PDF format.": "Die Datei muss im PDF-Format vorliegen.", 
    ...
    "Footer": "Fu\u00dfzeile", 
    "For already done past courses, if the badge is not shown, please visit the progress page of the course. If the badge still does not appear in this section, the course may be not configured to give badges.": "F\u00fcr bereits durchgef\u00fchrte Kurse, wenn das Badge nicht angezeigt wird, besuchen Sie bitte die Fortschrittsseite des Kurses. Wenn das Badge in dieser Stelle immer noch nicht angezeigt wird, ist der Kurs m\u00f6glicherweise nicht f\u00fcr das Ausstellen von Badges konfiguriert.", 
    ...
    "I accept the {anchorStart}Terms of Service{anchorEnd} *": "Ich akzeptiere die {anchorStart} Nutzungsbedingungen {anchorEnd} *", 
    "ID": "ID", 
    ...
    "In order to obtain a Certificate, you need to introduce your National Identity Number and pay.": "Um ein Zertifikat zu erhalten, m\u00fcssen Sie Ihre Identit\u00e4tsnummer einf\u00fchren und bezahlen.", 
    ...
    "Introduce your National Identify Number.": "Stellen Sie Ihre nationale Identifizierungsnummer vor.", 
    ...
    "National Identity Number *": "Nationale Identit\u00e4tsnummer *", 
    ...
    "OK": "OK", 
    "Obtain a Certificate,": "Zertifikat erhalten", 
    "Obtain a Credential,": "Credential erhalten,", 
    "Ok": "Ok", 
    ...
    "Question": "Frage", 
    "Questions raise issues that need answers. Discussions share ideas and start conversations.": "Wenn Sie eine konkrete Antwort f\u00fcr ein Problem suchen, stellen Sie eine Frage. Um sich mit anderen Nutzern \u00fcber ein Thema auszutauschen und Ideen zu teilen, nutzen Sie die Diskussion. ", 
    "Queued": "Eingereiht", 
    "Reason": "Grund", 
    ...
    "Section": "Abschnitt", 
    "Select Course Run": "Kurslauf w\u00e4hlen", 
    ...
    "Specify an alternative to the official course credits number to display on certificates.": "Geben Sie eine Alternative zur offiziellen Kurspunktzahl an, die auf dem Zertifikat angezeigt werden soll.", 
    ...
    "Thank you for submitting your photos. We will review them shortly. You can now sign up for any %(platformName)s course that offers verified certificates. Verification is good for one year. After one year, you must submit photos for verification again.": "Vielen Dank f\u00fcr das Einsenden Ihrer Fotos. Wir werden sie bald \u00fcberpr\u00fcfen. Sie k\u00f6nnen sich jetzt beliebig f\u00fcr %(platformName)s Kurse mit gepr\u00fcften Zertifikaten anmelden. Ihre \u00dcberpr\u00fcfung ist g\u00fcltig f\u00fcr ein Jahr. Nach ein Jahr m\u00fcssen Sie Ihre Fotos f\u00fcr die \u00dcberpr\u00fcfung erneut einsenden. ", 
    ...
    "This content group is not in use. Add a content group to any unit from the {linkStart}Course Outline{linkEnd}.": "Diese Inhaltsgruppe ist nicht in Gebrauch. F\u00fcgen Sie eine Inhaltsgruppe zu einer beliebigen Einheit in der {linkStart}Kurs\u00fcbersicht{linkEnd} hinzu.", 
    "This content group is used in one or more units.": "Diese Inhaltsgruppe wird in einer oder mehreren Einheiten verwendet.", 
    "This content group is used in:": "Diese Inhaltegruppe wird genutzt in:", 
    ...
    "Upgrade to obtain a Certificate,": "Upgrade, um ein Zertifikat zu erhalten,", 
    "Upgrade to obtain a Credential,": "Upgrade, um ein Credential zu erhalten,", 
    "Upload": "Hochladen", 
    ...
    "Upload a PDF file with the program of the Course to display on certificates. Leave blank to not use it.": "Laden Sie eine PDF-Datei mit dem Programm des Kurses hoch, um sie auf Zertifikaten anzuzeigen. Leer lassen, um es nicht zu benutzen.", 
    ...
    "Upload course program.": "Kurs-Programm hochladen.", 
    ...
    "We've sent a message to {email_address}. Click the link in the message to reset your password.": "Eine Email wurde versendet an {email_address}. Benutzen sie den Link in der E-mail um das Passwort zu \u00e4ndern.", 
    "Web:": "Web:", 
    "Webcam": "Webcam", 
    ...
    "{0} is required": "{0} wird ben\u00f6tigt", 
    "{0} must be at least {1} characters": "{0} ben\u00f6tigt wenigstens {1} Zeichen", 
    "{0} must be the same as {1}": "{0} muss das gleiche sein wie {1}", 
