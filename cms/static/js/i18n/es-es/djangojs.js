...
(function (globals) {
  ...
  django.catalog = {
    ...
    "%(earned)s/%(possible)s point (ungraded)": [
      "%(earned)s/%(possible) de puntos (no calificados)", 
      "%(earned)s/%(possible) de puntos (no calificados)"
    ], 
    ...
    "%(num_points)s point possible (graded, results hidden)": [
      "%(num_points)s punto posible (calificado, resultados ocultos)", 
      "%(num_points)s puntos posibles (calificado, resultados ocultos)"
    ], 
    ...
    "About Me": "Sobre m\u00ed", 
    "About me": "Sobre m\u00ed", 
    "Accept the Terms of Service.": "Necesario aceptar las Condiciones del Servicio.", 
    ...
    "Connecting to Payment Processor...": "Conectando con la pasarela de pago...", 
    ...
    "Course Credits Override": "Sobreescribir los cr\u00e9ditos del curso", 
    ...
    "Create a %(link_start)sBadgr Backpack%(link_end)s account, or log in to your existing account": "Crea una cuenta en %(link_start)sBadgr Backpack%(link_end)s, o accede con tu cuenta existente", 
    "Create a %(link_start)sMozilla Backpack%(link_end)s account, or log in to your existing account": "Crea una cuenta en %(link_start)sMozilla Backpack%(link_end)s, o accede con tu cuenta existente", 
    ...
    "Errors": "Errores", 
    "Everyone who has staff privileges in this course": "Todos los que est\u00e1n apuntados o son profesores de este curso", 
    ...
    "File must be in PDF format.": "El archivo debe ser en formato PDF.", 
    ...
    "I accept the {anchorStart}Terms of Service{anchorEnd} *": "Acepto las {anchorStart}Condiciones del Servicio{anchorEnd} *", 
    "ID": "Identificaci\u00f3n", 
    ...
    "In order to obtain a Certificate, you need to introduce your National Identity Number and pay.": "Para obtener un Certificado, es necesario que introduzcas tu DNI y realices el pago.", 
    ...
    "Introduce your National Identify Number.": "Introduzca su Documento Nacional de Identidad.", 
    ...
    "National Identity Number *": "Documento Nacional de Identidad *", 
    ...
    "OK": "De acuerdo", 
    "Obtain a Certificate,": "Obtenci\u00f3n de Certificado,", 
    "Obtain a Credential,": "Obtenci\u00f3n de Credencial,", 
    "Ok": "De acuerdo", 
    ...
    "Settings": "Ajustes", 
    "Share on Badgr": "Comparte en Badgr", 
    "Share on Mozilla Backpack": "Comparte en Mozilla Backpack", 
    ...
    "Specify an alternative to the official course credits number to display on certificates.": "Especifica una alternativa al n\u00famero de cr\u00e9ditos oficiales del curso para mostrar en el certificado.", 
    ...
    "To share your certificate on Badgr, you must first have a Backpack account. Complete the following steps to add your certificate to Backpack.": "Para compartir tu certificado en Badgr Backpack, primero debes tener una cuenta Backpack. Completa los siguientes pasos para a\u00f1adir tu certificado a Backpack.", 
    "To share your certificate on Mozilla Backpack, you must first have a Backpack account. Complete the following steps to add your certificate to Backpack.": "Para compartir tu certificado en Mozilla Backpack, primero debes tener una cuenta Backpack. Completa los siguientes pasos para a\u00f1adir tu certificado a Backpack.", 
    ...
    "Upgrade to obtain a Certificate,": "Actualizaci\u00f3n para obtenci\u00f3n de Certificado,", 
    "Upgrade to obtain a Credential,": "Actualizaci\u00f3n para obtenci\u00f3n de Credencial,", 
    "Upload": "Subir", 
    ...
    "Upload a PDF file with the program of the Course to display on certificates. Leave blank to not use it.": "Sube un archivo PDF con el programa del curso para mostrarlo en el certificado. D\u00e9jalo en blanco para no usarlo.", 
    ...
    "Upload course program.": "Sube el programa del curso.", 
    ...
    "You are sending an email message with the subject {subject} to the following recipients.": "Est\u00e1s a punto de enviar un correo electr\u00f3nico con t\u00edtulo {subject} a los siguientes destinatarios.", 
    "You are upgrading your enrollment for: {courseName}": "Est\u00e1s mejorando tu inscripci\u00f3n en: {courseName}", 
