...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "%(download_link_start)sDownload this image (right-click or option-click, save as)%(link_end)s and then %(upload_link_start)supload%(link_end)s it to your backpack.</li>": "%(download_link_start)sBaixe esta imagem (clique com o bot\u00e3o direito ou clique segurando a tecla Option, salvar como)%(link_end)s, em seguida, %(upload_link_start)scarregue %(link_end)s a imagem para sua backpack</li>.", 
