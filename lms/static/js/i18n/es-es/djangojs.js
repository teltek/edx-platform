...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "(Self-paced) Started {start}": "(Self-paced) Empezado {start}", 
    "(Self-paced) Starts {start}": "(Self-paced) Empieza {start}", 
    ...
    "Are you sure you want to change to a different session?": "\u00bfEst\u00e1s seguro de que quieres cambiar a una sesi\u00f3n diferente?", 
    ...
    "Failed to rescore problem to improve score for user.": "Error al volver a analizar el problema para mejorar la puntuaci\u00f3n para el usuario.", 
    ...
    "If you still wish to continue and delete your account, please enter your account password:": "Si a\u00fan desea continuar y eliminar su cuenta, ingrese la contrase\u00f1a de su cuenta:", 
    ...
    "Load next {num_items} result": [
      "Cargar siguiente {num_items} resultado", 
    ...
    "More sessions coming soon.": "M\u00e1s sesiones pr\u00f3ximamente.", 
    "Move": "Mover", 
    "Move cancelled. \"{sourceDisplayName}\" has been moved back to its original location.": "Movimiento anulado. \"{sourceDisplayName}\" se ha movido a su localizaci\u00f3n original.", 
    ...
    "Once in position, use the camera button {icon} to capture your ID": "Una vez en posici\u00f3n, use el bot\u00f3n de la c\u00e1mara {icon} para capturar su ID", 
    "Once in position, use the camera button {icon} to capture your photo": "Una vez en posici\u00f3n, use el bot\u00f3n de la c\u00e1mara {icon} para capturar su foto ", 
    ...
    "Thank you for submitting a request! We will contact you within 24 hours.": "\u00a1Gracias por enviar una solicitud! Nos pondremos en contacto con usted dentro de las 24 horas.", 
    ...
    "The following information is already a part of your {platform} profile. We\\'ve included it here for your application.": "La siguiente informaci\u00f3n ya es parte de su perfil de {platform}  Lo hemos incluido aqu\u00ed para su aplicaci\u00f3n.", 
    ...
    "To finalize course credit, %(display_name)s requires %(platform_name)s learners to submit a credit request.": "Para finalizar la acreditaci\u00f3n del curso %(display_name)s se requiere%(platform_name)sque los estudiantes tienen que enviar una solicitud de reconocimiento.", 
    ...
    "To use the current photo, select the camera button {icon}. To take another photo, select the retake button {icon}.": "Para usar la foto actual, seleccione el bot\u00f3n de la c\u00e1mara {icon}. Para tomar otra foto, seleccione el bot\u00f3n de volver a tomar {icon}.", 
    ...
    "We have received your information and are verifying your identity. You will see a message on your dashboard when the verification process is complete (usually within 1-2 days). In the meantime, you can still access all available course content.": "Hemos recibido su informaci\u00f3n y estamos verificando su identidad. Ver\u00e1 un mensaje en su panel de control cuando se complete el proceso de verificaci\u00f3n (generalmente dentro de 1-2 d\u00edas). Mientras tanto, todav\u00eda puedes acceder a todo el contenido del curso disponible.", 
    ...
    "When your face is in position, use the camera button {icon} below to take your photo.": "Cuando su cara est\u00e9 en posici\u00f3n, use el bot\u00f3n de la c\u00e1mara {icon} a continuaci\u00f3n para tomar su foto.", 
    ...
    "Yes, delete this {xblock_type}": "Si, eliminar {xblock_type}", 
    ...
    "You need a computer that has a webcam. When you receive a browser prompt, make sure that you allow access to the camera.": "Necesitas un ordenador que tenga una webcam. Cuando reciba un aviso del navegador, aseg\u00farese de permitir el acceso a la c\u00e1mara.", 
    ...
    "You still need to visit the %(display_name)s website to complete the credit process.": "A\u00fan debe visitar el %(display_name)ssitio web para completar el proceso de cr\u00e9dito.", 
